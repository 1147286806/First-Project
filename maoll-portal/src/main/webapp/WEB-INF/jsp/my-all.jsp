				...
				<div class="pc-nav-digit clearfix">
					<ul>
						<c:forEach items="${productList}" var="productList">
							<li>
								<div class="digit1"><a href="${ctx}/product/Page.shtml?id=${productList.id}"><img src="${ctx}/static/font/images/shangpinxiangqing/X-1.png" width="100%"></a></div>
								<div class="digit2"><a href="${ctx}/product/Page.shtml?id=${productList.id}">${productList.name}</a></div>
							</li>
						</c:forEach>
					</ul>
				</div>
